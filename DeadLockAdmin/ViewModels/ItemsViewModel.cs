...
namespace DeadLockAdmin.ViewModels
{
    ...
    {
        private const string ItemsApiUrl = "http://deadlock/api/items"; // URL для API, который предоставляет данные о предметах
        ...
        private async void LoadItemsAsync()
        {
            ...
            {
                item.Image = $"http://deadlock/public/storage/{item.Image}";
            }
